...
const POLISH_WORD_PATTERN =
  /\b(czesc|dzien dobry|prosze|wycena|lazienka|mieszkanie|remont|winda|pietro|miasto|termin|jutro|warszawa|gdansk|gdynia|sopot)\b/i;
const ENGLISH_WORD_PATTERN =
  /\b(hello|hi|please|estimate|bathroom|kitchen|renovation|repair|paint|tile|floor|lift|city|deadline|tomorrow|next week)\b/i;
